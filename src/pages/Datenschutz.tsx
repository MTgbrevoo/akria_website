            ...
            <main>
                ...
                <div className="mx-auto grid max-w-6xl gap-12 px-5 py-12 sm:px-8 lg:grid-cols-[16rem_minmax(0,1fr)] lg:gap-16 lg:py-16">
                    ...
                    <article className="min-w-0">
                        ...
                        <LegalSection id="google-places" title="5a. Adressvorschläge von Google Maps">
                            <p>Wenn die Adresshilfe aktiviert ist, nutzen wir Google Maps Places, um dir beim Ausfüllen deiner Bestelladresse passende Vorschläge anzuzeigen. Sobald du mindestens drei Zeichen im Straßenfeld eingibst, wird Google Maps geladen. Dabei werden deine Sucheingabe, IP-Adresse und technische Browserinformationen an Google übertragen. Name und E-Mail-Adresse werden von uns nicht für die Adresssuche übermittelt.</p>
                            <p>Nach Auswahl eines Vorschlags werden die verfügbaren Adressbestandteile in das Formular übernommen. Bitte prüfe und ergänze diese Angaben. Wir speichern die von dir bestätigte Adresse für deine Bestellung. Die Vorschlagslisten werden von uns nicht dauerhaft gespeichert. Die manuelle Eingabe bleibt möglich.</p>
                            <p>Google verarbeitet Daten gemäß seiner <PrivacyLink href="https://policies.google.com/privacy">Datenschutzerklärung</PrivacyLink>; dabei kann eine Verarbeitung außerhalb der EU beziehungsweise der Schweiz stattfinden. Für die Nutzung der Adresshilfe gelten die <PrivacyLink href="https://maps.google.com/help/terms_maps/">Nutzungsbedingungen von Google Maps</PrivacyLink>.</p>
                            <p>Über diese Ergebnisse: Google ordnet die Vorschläge insbesondere nach Relevanz, Entfernung und Bekanntheit. Die Reihenfolge wird von uns nicht verändert; die Suche ist auf Deutschland und die Schweiz beschränkt. <PrivacyLink href="https://support.google.com/business/answer/7091">Weitere Informationen zur Reihenfolge der Google-Ergebnisse</PrivacyLink>.</p>
                        </LegalSection>
