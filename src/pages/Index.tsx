...
export default function Index() {
    ...
    return (
        <div className="bg-primary min-h-screen">
            <NoiseOverlay />
            <Impressum isOpen={showImpress<dyad-write path="src/pages/Index.tsx" description="Floating CTA bleibt sichtbar und dockt am Ende nahtlos in der Waitlist-Sektion an">
"use client";
